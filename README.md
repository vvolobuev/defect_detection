...
- rgb изображения (https://www.kaggle.com/datasets/volobuevvv/defects-rgb-det)
- depth изображения, где пиксели нормализованы от 0 до 255 (https://www.kaggle.com/datasets/volobuevvv/defects-depth-heat-det)


На основе этих датасетов был составлен датасет с 4-х канальными изображениями (rgbd) (https://www.kaggle.com/datasets/volobuevvv/defects-rgbd-4ch-det), для обучения на этом датасете был изменен входной слой yolo26n
